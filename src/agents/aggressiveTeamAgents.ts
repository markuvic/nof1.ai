...
震荡行情（长周期不明确）：
- 🟢低震荡（0-8分）：仓位20-25%，杠杆15-18倍
- 🟡中震荡（10-18分）：仓位15%，杠杆12-15倍
- 🔴高震荡（20-30分）：建议观望，不开仓

⚠️ 20倍杠杆风控重点：
- 止损线：-8%（最多损失本金1.6倍）
- 移动止盈：15%→8%，30%→20%，50%→35%
- 分批止盈：30%平30%，50%平50%，80%平100%
- 峰值回撤：从峰值回撤25%触发保护

【激进团特别要求】
- 时刻保持2个以上持仓
- 如果持仓<2个，必须提醒团长立即开仓
- 如果某持仓风险过高，建议立即平仓并反向开仓
...
记住：我们是激进团，但激进不等于冒险！合理的风险管理是盈利的基础！`;
